...
def send_email(sender, receiver, subject, body, file_content, file_name):
    ...
    response = ses.send_raw_email(Source = sender, Destinations = receiver, RawMessage = {"Data": msg.as_string()})
...
def lambda_handler(event, context):
    if "Records" in event:
        ...
        response = send_email(SENDER_EMAIL, TO_EMAILS, subject, body, file_content, file_name)
    ...
    return {
        'statusCode': 500,
        'body': json.dumps('Email delivery failed!')
    }
